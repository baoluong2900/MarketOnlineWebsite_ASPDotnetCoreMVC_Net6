...
namespace MarketOnlineWebsite.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Thumb,Published,Title,Alias,CreatedDate,Ordering")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
