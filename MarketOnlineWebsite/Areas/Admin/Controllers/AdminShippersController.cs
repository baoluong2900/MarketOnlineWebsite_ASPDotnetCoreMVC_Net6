...
namespace MarketOnlineWebsite.Areas.Admin.Controllers
{
    ...
    public class AdminShippersController : Controller
    {
        ...
        public AdminShippersController(dbMarketsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ShipperId,SupplierId,ShipperName,Phone,Birthday,Email,LocationId,District,Ward,Avatar,ShipDate,Active")] Shipper shipper)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShipperId,SupplierId,ShipperName,Phone,Birthday,Email,LocationId,District,Ward,Avatar,ShipDate,Active")] Shipper shipper)
        {
