...
namespace MarketOnlineWebsite.Areas.Admin.Controllers
{
    ...
    public class AdminNewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,Title,Scontents,Contents,Thumb,Published,Alias,CreatedDate,Author,AccountId,Tags,CatId,IsHot,IsNewfeed,Views")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,Title,Scontents,Contents,Thumb,Published,Alias,CreatedDate,Author,AccountId,Tags,CatId,IsHot,IsNewfeed,Views")] News news)
        {
            if (id != news.PostId)
            {
                return NotFound();
