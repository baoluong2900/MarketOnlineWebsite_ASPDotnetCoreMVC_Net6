...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=MSI;Database=dbMarkets;Trusted_Connection=True;User Id=sa;Password=123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.AdvertisementsId)
                    .HasName("PK_QuangCaos");

                entity.Property(e => e.AdvertisementsId).HasColumnName("AdvertisementsID");
            ...
            modelBuilder.Entity<Supplier>(entity =>
            {
                ...
                entity.HasOne(d => d.Location)
                    .WithMany(p => p.Suppliers)
                    .HasForeignKey(d => d.LocationId)
                    .HasConstraintName("FK_Suppliers_Locations");
            });
